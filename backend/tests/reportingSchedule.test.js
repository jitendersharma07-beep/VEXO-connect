...
const wipe = async () => {
  ...
  // Kitchen before the order items they hang off. KitchenItem cascades from
  // OrderItem, but Kot does not, and a leftover Kot from another suite is enough
  // to make this one fail before its first assertion.
