...
export const EXTENSION_POINTS = Object.freeze([
  ...
  { module: 'PROMOTIONS', prefix: 'promo.', note: 'Offers and loyalty — promotions lane' },
...
const SELL = ['order.read', 'order.create', 'order.bill', 'kot.read', 'payment.record', 'table.read', 'catalog.read'];
...
const ROLE_ACTIONS = Object.freeze({
  ...
  REGIONAL_MANAGER: Object.freeze([
    ...
    'report.sales.read', 'report.tax.read',
